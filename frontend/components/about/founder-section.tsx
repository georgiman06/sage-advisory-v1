    ...
    <>
      ...
      <section className="border-t border-border dark:border-white/10 py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <Card className="mt-12 border-blue-200 dark:border-amber-400/25 bg-white/80 dark:bg-[#162548]/80 backdrop-blur-sm">
            <CardContent className="p-8 md:p-12">
              <div className="grid items-start gap-10 md:grid-cols-[320px_1fr]">
                <div className="relative aspect-[4/5] w-full overflow-hidden rounded-xl border border-blue-300 dark:border-amber-400/25 bg-blue-50 dark:bg-[#0f1d38]">
                ...
                <div className="relative">
                  <a
                    ...
                    className="absolute right-0 top-0 text-muted-foreground dark:text-white/50 hover:text-amber-500 dark:hover:text-amber-400"
                  >
                  ...
                  <p className="mt-2 text-2xl font-semibold text-amber-600 dark:text-amber-300/90">
                    {founder.role}
                  </p>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {topSkills.map((skill) => (
              <div
                key={skill}
                className="rounded-lg border border-white/10 bg-white/10 p-6 backdrop-blur-sm transition-all hover:border-amber-400/40 hover:bg-white/15"
              >
