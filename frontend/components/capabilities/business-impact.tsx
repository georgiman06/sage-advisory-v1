        ...
        <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {impacts.map((impact) => {
            ...
            return (
              <div
                key={impact.title}
                className="flex flex-col rounded-xl border border-border dark:border-white/10 bg-card dark:bg-[#162548]/80 p-6 backdrop-blur-sm transition-all hover:border-amber-400/40 hover:bg-blue-50/50 dark:hover:bg-[#162548]/90"
              >
