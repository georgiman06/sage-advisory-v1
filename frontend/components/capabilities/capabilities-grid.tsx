          ...
          {paths.map((d, i) => {
            ...
            return (
              <path
                key={i}
                d={d}
                stroke={isActive ? "rgba(147,197,253,0.9)" : "rgba(147,197,253,0.45)"}
                ...
                <div>
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3">
                      <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-amber-500/15">
                  ...
                  <div className="mt-5">
                    <p className="text-sm font-bold uppercase tracking-wide text-amber-400/80">
                      {node.servicesLabel}
                    </p>
